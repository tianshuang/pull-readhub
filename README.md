...
下载 [pull-readhubme-0.0.9-SNAPSHOT.jar](https://storage.tianshuang.me/pull-readhubme/pull-readhubme-0.0.9-SNAPSHOT.jar)
...
```Bash
chmod u+x pull-readhubme-0.0.9-SNAPSHOT.jar
./pull-readhubme-0.0.9-SNAPSHOT.jar &
```
