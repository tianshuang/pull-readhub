...
下载 [pull-readhubme-0.0.8-SNAPSHOT.jar](https://storage.tianshuang.me/pull-readhubme/pull-readhubme-0.0.8-SNAPSHOT.jar)
...
```Bash
chmod u+x pull-readhubme-0.0.8-SNAPSHOT.jar
./pull-readhubme-0.0.8-SNAPSHOT.jar &
```
